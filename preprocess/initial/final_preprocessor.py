...
class ComLoader:
    ...
    def _read_data(self):
        self.df_user_item = pd.read_csv(os.path.join(self.base_dir, 'data', 'user_item_interactions.csv'))
    ...
    def _save_processed_data(self):
        ...
        df_processed.to_csv(os.path.join(self.base_dir, 'data', 'processed_data.csv'), index=False)
